    ...
    */
    ...
    'connections' => [
        ...
        'integracion' => [
            'driver' => 'mysql',
            //'url' => env('DATABASE_URL'),
            'host' => env('INT_HOST', '127.0.0.1'),
            'port' => env('INT_PORT', '3306'),
            'database' => env('INT_DATABASE', 'forge'),
            'username' => env('INT_USERNAME', 'forge'),
            'password' => env('INT_PASSWORD', ''),
            //'unix_socket' => env('DB_SOCKET_MIPROVEEDOR', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
